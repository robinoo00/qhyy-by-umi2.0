...
export default class extends Base {
    ...
    _test() {
        ...
        this.画布上下文.font = "25px sans-serif";
        this.画布上下文.fillText('放大倍数:'+this.scale,50,100)
        this.画布上下文.fillText('K线显示柱条数:'+this.K线显示柱条数,50,150)
        this.画布上下文.fillText('数据总长:'+this.data.length,50,200)
        this.画布上下文.fillText('拖动条数:'+this.拖动条数,50,250)
        this.画布上下文.restore();
    }
    /*开始绘制*/
    draw() {
